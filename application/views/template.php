              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      ...
                      <a href="javascript:;" >
                          ...
                          <i><img src="<?=base_url();?>assets/img/pelanggan.png" alt=""></i>
                          <span>Pelanggan</span>
                      </a>
                      <ul class="sub">
                          <li><a  href="<?=base_url('index.php/pelanggan')?>">Data Pelanggan</a></li>
                          <li><a  href="<?=base_url('index.php/pelanggan/DaftarPelanggan')?>">Daftar Pelanggan</a></li>
                      </ul>
                        </div>
                  </li>
                  ...
                  <li class="mt">
                      ...
                      <a href="javascript:;" >
                          <!-- <i class="fa fa-desktop"></i> -->
                          <i><img src="<?=base_url();?>assets/img/things.png" alt=""></i>
                          <span>Barang</span>
                      </a>
                      <ul class="sub">
